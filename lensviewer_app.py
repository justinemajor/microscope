...
class OpticalComponentViewer(App):
    ...
    def build_table(self):
        ...
        self.table.data_source._field_properties['backFocalLength'] = {'type':float}
        self.table.data_source._field_properties['frontFocalLength'] = {'type':float}
        self.table.data_source._field_properties['effectiveFocalLengths'] = {'type':float}
        self.table.data_source._field_properties['apertureDiameter'] = {'type':float}
        self.table.data_source._field_properties['wavelengthRef'] = {'type':float}
